...
function numeroRandom(_num) {
  //Generar un número al azar entre 0 y 1 y devolverlo
  //Pista: investigá qué hace el método Math.random()
  return Math.random()
}

function esPositivo(_num) {
...
function combinarNombres(_firstName, _lastName) {
...
function obtenerSaludo(_firstName) {
  // Toma la string "nombre" y concatena otras string en la cadena para que tome la siguiente forma:
  // "Martin" -> "Hola Martin!"
  // Tu código:
  return "Hola " + _firstName + "!";
}
...
function esVocal(_letra){
  ...
  //Escribe tu código aquí
if (_letra.length > 1 ) return "Dato incorrecto";
if (_letra === "a" ) return "Es vocal";
if (_letra === "e" ) return "Es vocal";
if (_letra === "i" ) return "Es vocal";
if (_letra === "o" ) return "Es vocal";
if (_letra === "u" ) return "Es vocal";
